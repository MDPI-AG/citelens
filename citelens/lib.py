...
@lru_cache(maxsize=1)
def get_tokenizer_model() -> tuple[Any, Any]:
...
def process_item(
    item: CitationItem, article_reference_threshold: float, context_reference_threshold: float
) -> SimilarityResult:
    ...
    context_reference_similarity = None
    context_reference_alert = None
    if item.context:
        ...
        context_reference_alert = context_reference_similarity < context_reference_threshold
    ...
    return SimilarityResult(
        ...
        article_reference_alert=article_reference_similarity < article_reference_threshold,
        context_reference_alert=context_reference_alert,
    )
